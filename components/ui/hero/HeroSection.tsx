  ...
  return (
    ...
    >
      <div className='w-[90%] md:w-full mx-auto min-h-screen flex flex-col items-center justify-center gap-16 bg-cover bg-center py-24 px-4 text-white'>
          <h1 className='w-full md:max-w-[800px] lg:max-w-[1000px] xl:max-w-[1600px] text-5xl sm:text-6xl md:text-7xl xl:text-8xl 2xl:text-9xl font-bold text-center'>{title}</h1>
