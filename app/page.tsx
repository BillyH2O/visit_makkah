  ...
  return (
    <div className="min-h-screen w-full font-sans dark:bg-black">
      ...
      <div className="relative w-full h-full">
        <section className="w-full -mt-24 sm:-mt-32 py-16 mx-auto max-w-7xl px-4 sm:px-12 xl:px-32 2xl:px-0 flex flex-col items-center justify-center gap-64 relative">
          <OfferSection />
          <ServiceSection />
          <SadaqaSection />
        </section>
